    ...
    <>
        ...
        <Navbar.Collapse id="navbarScroll">
          ...
          >
            <NavDropdown title="Women" id="navbarScrollingDropdown">
              <Link href="/women/tops" passHref>
                <NavDropdown.Item>Tops</NavDropdown.Item>
              </Link>
              <Link href="/women/dresses" passHref>
                <NavDropdown.Item>Dresses</NavDropdown.Item>
              </Link>
              <Link href="/women/bottoms" passHref>
                <NavDropdown.Item>Bottoms</NavDropdown.Item>
              </Link>
              <Link href="/women/outerwear" passHref>
                <NavDropdown.Item>Outerwear</NavDropdown.Item>
              </Link>
              <Link href="/women/accessories" passHref>
            ...
            <Link href="/men/tops" passHref>
             <NavDropdown.Item>Tops</NavDropdown.Item>
            </Link>
            <Link href="/men/bottoms" passHref>
              <NavDropdown.Item>Bottoms</NavDropdown.Item>
            </Link>
            <Link href="/men/footwear" passHref>
              <NavDropdown.Item>Footwear</NavDropdown.Item>
            </Link>
            <Link href="/men/outerwear" passHref>
              <NavDropdown.Item>Outerwear</NavDropdown.Item>
            </Link>
            <Link href="/men/accessories" passHref>
              <NavDropdown.Item>Accessories</NavDropdown.Item>
            </Link>
            </NavDropdown>
          ...
          <Form className="icons d-flex">
            ...
            {/* <Image src="/search.svg" className='nav-icon' alt="Logo" width={20} height={25}/>
            <Image src="/person.svg" className='nav-icon' alt="Logo" width={25} height={25}/>
            <Image src="/cart.svg" className='nav-icon' alt="Logo" width={20} height={25}/>
          </Form>
     ...
     <div className="bg-white">
      ...
      <header className="relative bg-white">
        {/* <p className="flex h-10 items-center justify-center bg-orangey px-4 text-sm font-medium text-white sm:px-6 lg:px-8">
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <a href="#">
                  ...
                  <h1 className='text-xl'>Evergreen</h1>
                  {/* <img
                    alt=""
              ...
              <div className="ml-auto flex items-center">
                ...
                <div className="hidden lg:ml-8 lg:flex">
                  <a href="#" className="flex items-center text-gray-700 hover:text-gray-800">
                    <img
                      alt=""
                      src="https://tailwindui.com/plus/img/flags/flag-united-kingdom.svg"
                      className="block h-auto w-5 flex-shrink-0"
                    />
